...
export default function AdminEditProductPage() {
  ...
  return (
    <div>
      ...
      <h1 className="text-xl font-semibold text-gray-900 mb-6">Edit Produk</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-1 space-y-4">
            ...
            <button
              ...
              className="w-full flex cursor-pointer hover:bg-gray-200 items-center justify-center gap-2 px-4 py-2.5 border border-gray-300 text-black text-sm font-medium rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isLoading ? (
                <>
                  <Loader size="sm" />
